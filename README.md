...
<p align="center"> <img src="drawing.jpg" alt="drawing" width="400"/> </>
...
Now generate a altitude map:

The value at each point on the altitude map is generated by how far the pixel is to the top and bottom of the texture. So the center of the texture has values close to 1, and the top/has the values close to 0.
